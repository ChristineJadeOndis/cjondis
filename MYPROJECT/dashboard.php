                ...
                ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="delete_order.php?order_id=<?php echo urlencode($row['order_id']); ?>" class="btn btn-delete" onclick="return confirm('Are you sure you want to delete this order?');">Delete</a>
                        </td>
                    </tr>
                <?php endwhile; ?>
